...
import com.ratnesh.buildly.repository.PlanRepository;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public CheckoutResponse createCheckoutSessionUrl(CheckoutRequest request) {
        ...
        try {
            ...
            //sdk makes api call to stripe server
    ...
    public void handleWebhookEvent(String type, StripeObject stripeObject, Map<String, String> metadata) {
        ...
        switch(type){
            ...
            case "customer.subscription.deleted" -> handleCustomerSubscriptionDeleted((Subscription) stripeObject);// when subscription ends, access is revoked
